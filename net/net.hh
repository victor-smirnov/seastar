...
public:
    ...
    seastar::subscription<packet, ethernet_address> receive(
...
class interface {
    struct l3_rx_stream {
    	seastar::stream<packet, ethernet_address> packet_stream;
        future<> ready;
        std::function<bool (forward_hash&, packet&, size_t)> forward;
    ...
    seastar::subscription<packet> _rx;
...
public:
    ...
    seastar::subscription<packet, ethernet_address> register_l3(eth_protocol_num proto_num,
...
class qp {
    ...
    seastar::stream<packet> _rx_stream;
...
public:
    ...
    seastar::subscription<packet> receive(std::function<future<> (packet)> next_packet);
